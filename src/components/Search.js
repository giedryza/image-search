...
const Search = () => {
  ...
  const handleSearchSubmit = e => {
    ...
    if (!query) {
      ...
      setSearchSubmit({ ...searchSubmit, page: 1, query });
    }
  };
  ...
  const handleSearchSaveSubmit = query => {
    ...
    setSearchSubmit({ ...searchSubmit, query, page: 1 });
  };
      ...
      <section id="controls">
        <form onSubmit={handleSearchSubmit} className="search">
          ...
          <div className="search__actions">
            ...
            <ButtonPrimary type="button" icon="check" text="Save" onClick={handleSearchSave} />
          </div>
        </form>
      </section>
